...
function submit() {
    ...
    console.log("/updateVegetables/" + inputIds + "/" + inputVals);
    window.location = "/updateVegetables/" + inputIds + "/" + inputVals;
}
...
function deleteUser(event) {
    ...
    window.location = "/deleteVegetables/" + event.target.parentNode.nextElementSibling.innerText;
}
