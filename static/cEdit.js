...
function submit() {
    ...
    console.log("/updateClothing/" + inputIds + "/" + inputVals);
    window.location = "/updateClothing/" + inputIds + "/" + inputVals;
}
...
function deleteUser(event) {
    ...
    window.location = "/deleteClothing/" + event.target.parentNode.nextElementSibling.innerText;
}